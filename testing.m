function testing(signalAddress,signalListAddress,timingContstraintContent)
disp('testing func');
disp(signalAddress);
...
if(size(find(siblingsIndices==0),2)== 0)
   ...
   calculatedTs = callingFunc(currentOperator,operatorContent,operatorInput,startTime,stopTime);
